...
const AD_SLOTS = [
  {
    ...
    url: "https://stax.ai",
    headline: "STAX&nbsp;AI",
    sub: "Options flow, decoded.",
    body: "Unusual activity, dealer positioning and what the tape is actually saying — without the guesswork.",
    cta: "ENTER SITE",
    skin: "stax",
  },
  {
    ...
    headline: "TRADES&nbsp;&amp;&nbsp;GAINS",
    sub: "The Close, every day.",
    body: "Daily market recaps, earnings breakdowns and the numbers behind the noise. Free to read.",
    cta: "VISIT NOW",
    skin: "tg",
  },
  {
